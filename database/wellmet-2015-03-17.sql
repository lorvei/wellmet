...
--
-- Hoszt: 127.0.0.1
-- Létrehozás ideje: 2015. Már 17. 13:48
...
CREATE TABLE IF NOT EXISTS `erdeklodesikor` (
...
--
-- A tábla adatainak kiíratása `erdeklodesikor`
--

INSERT INTO `erdeklodesikor` (`id`, `kor`) VALUES
(1, ''),
(2, ''),
(3, 'fal'),
(4, 'fut'),
...
(2, '', 'valamiasd', 'hkjhnoiuchujhwelkjoöivjdfiougvoefvuojhuirf', '2014-11-19', 2, 1),
...
(4, 'Eltűnt', 'Tesztalany', 'Megtalálták', '2015-03-04', 3, 0),
...
(23, 11, '1985-04-05', 'Nő', '2015-03-17', 'autók, animék, zenék', 'hello', 'Somogy'),
(30, 10, '1992-05-05', 'Nő', '2015-03-17', 'ivászat, animék', 'adasdasd', 'Komárom-Esztergom');
